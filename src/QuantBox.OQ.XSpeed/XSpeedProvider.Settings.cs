...
namespace QuantBox.OQ.XSpeed
{
    partial class XSpeedProvider
    {
        ...
        [DefaultValue(DFITCSpeculatorType.SPECULATOR)]
        public DFITCSpeculatorType SpeculatorType
        {
            get;
            set;
        }
        ...
        private readonly string accountsFile = string.Format(@"{0}\XSpeed.Accounts.xml", Framework.Installation.IniDir);
        void LoadAccounts()
        {
            accountsList.Clear();
        ...
        private readonly string serversFile = string.Format(@"{0}\XSpeed.Servers.xml", Framework.Installation.IniDir);
        void LoadServers()
        {
            serversList.Clear();
        ...
        private readonly string brokersFile = string.Format(@"{0}\XSpeed.Brokers.xml", Framework.Installation.IniDir);
